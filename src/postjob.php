  ...
  <div class="container bg-gray-900 mx-auto px-4 py-16 mt-20">
    ...
    <input type='hidden' value="<?php echo $id; ?>" name='id' />
      ...
      <div class="mb-4">
        ...
        <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="employmentType">
