          ...
          <tbody>
            ...
            ?>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-center">
                  ...
                  <td class="px-6 py-4">
                    <a href="#" class="font-medium text-gray-400 hover:underline"><i class="fas fa-check-circle fa-lg text-green-500"></i></a>
                  </td>
                  <td class="px-6 py-4">
                    <a href="#" class="font-medium text-gray-400 hover:underline"><i class="fas fa-times-circle fa-lg text-red-500"></i></a>
                  </td>
                </tr>
            <?php
              }
