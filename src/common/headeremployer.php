...
<nav class="bg-white border-gray-200 dark:bg-gray-900 fixed top-0 w-full transition transform duration-500 ease-in-out">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="employerAccount.php" class="flex items-center">
            <img src="../img/icon.png" class="h-8 mr-2 mt-1" />
            <span
                class="self-center text-3xl whitespace-nowrap dark:text-white font-semibold tracking-tight leading-none">HUNTSPOT</span>
        </a>
            ...
            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
                ...
                <div class="px-4 py-3">
                    <span class="block text-sm text-gray-900 dark:text-white">
                        ...
                        <a href="employerAccount.php"><?php echo $_SESSION['name']; ?></a>
                    </span>
                    ...
                    <span class="mt-2 block text-sm text-gray-900 dark:text-white">
                        ...
                        <a href="viewApplicants.php">View applications</a>
                    </span>
                    <span class="mt-2 block text-sm text-gray-900 dark:text-white">
