...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(empty(trim($_POST["name"]))){
        ...
        $sql = "SELECT id FROM employer WHERE name = ?";
...
{
    $sql = "INSERT INTO employer (name, email, password) VALUES (?,?,?)";
    $stmt = mysqli_prepare($conn, $sql);
    if ($stmt)
    {
...
<body class="bg-zinc-100">
  ...
  <?php if($password_err != ""){
        ...
        <div class="ml-3 text-sm font-medium text-red-700 dark:text-red-800">
          <strong class="font-bold">Error!! </strong>Something went wrong!!. <a href="emprlogin.php" class="font-semibold underline hover:text-red-800 dark:hover:text-red-900">Try Again</a>.
        </div>
      ...
      <div class="flex flex-col md:flex-row">
        ...
        <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2 bg-gray-800">
          <div class="w-full">
            ...
            <form action="emprsignup.php" method="post">
            <div class="mt-4">
                <input type="text"
