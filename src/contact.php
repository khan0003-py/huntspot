...
<body class="bg-gray-900">
    ...
    <div
        class="max-w-screen-xl mt-28 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-400 text-gray-900 rounded-lg shadow-lg">
        ...
        <div class="">
            ...
            <div class="mt-8">
                ...
                <textarea
                    class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" placeholder="Message..."></textarea>
            </div>
            <div class="mt-8">
                <button
                    class="uppercase text-sm font-bold tracking-wide bg-gray-700 text-gray-200 hover:text-gray-300 hover:bg-gray-900 border border-gray-900 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                    Send Message
                </button>
            </div>
        </div>
